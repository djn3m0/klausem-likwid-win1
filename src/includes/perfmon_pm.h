...
static int perfmon_numCountersPM = NUM_COUNTERS_PM;
static int perfmon_numGroupsPM = NUM_GROUPS_PM;
static int perfmon_numArchEventsPM = NUM_ARCH_EVENTS_PM;
